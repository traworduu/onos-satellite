 ...
 */
public class SatelliteDeviceViewMessageHandler extends UiMessageHandler {

    private static final String ROADM_DEVICE_DATA_REQ = "satelliteDataRequest";
    private static final String ROADM_DEVICE_DATA_RESP = "satelliteDataResponse";
    private static final String ROADM_DEVICES = "satellites";
    ...
    private final class DeviceTableDataRequestHandler extends TableRequestHandler {
        ...
        private void populateRow(TableModel.Row row, Device device) {
            ...
            row.cell(ID, id)
                    .cell(NAME, SatelliteUtil.getAnnotation(device.annotations(), AnnotationKeys.NAME, id))
                    .cell(TYPE, SatelliteUtil.objectToString(device.type(), SatelliteUtil.UNKNOWN))
                    ...
                    .cell(PROTOCOL, SatelliteUtil.getAnnotation(device.annotations(), PROTOCOL));
        }
    }
}
