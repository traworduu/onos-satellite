 ...
 */
@Component(immediate = true, service = SatelliteStore.class)
public class DistributedSatelliteStore implements SatelliteStore {
    private static Logger log = LoggerFactory.getLogger(DistributedSatelliteStore.class);
    ...
    public void activate() {
        distPowerMap = storageService.<DeviceId, Map<PortNumber, Double>>consistentMapBuilder()
                .withName("onos-satellite-distributed-store")
